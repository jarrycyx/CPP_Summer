...
{
    QObject::connect(storage, SIGNAL(sendErrorMessage(QString)),
                     this, SIGNAL(sendErrorMessage(QString)));
    QObject::connect(storage, SIGNAL(sendSuccessMessage(QString)),
                     this, SIGNAL(sendSuccessMessage(QString)));
}
